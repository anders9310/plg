...
public class TestProcessGeneration {
    ...
    private static final int NUM_GENERATED_MODELS = 1000;
    ...
    private static List<File> generateProcessModelFiles(){
        ...
        for(int i = 0; i< NUM_GENERATED_MODELS; i++){
            ...
            ObligationsProcessGenerator.randomizeProcess(p, new ParameterRandomizationConfiguration(p, 10, 0, 0, 0, 0, 0));
